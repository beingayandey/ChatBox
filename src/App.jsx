...
import { ThemeProvider } from "./components/contexts/ThemeContext"; // Theme context provider

// App component: The root of the application
const App = () => {
  return (
    // Wrap everything in ThemeProvider to enable styling/theme context across all routes
    <ThemeProvider>
